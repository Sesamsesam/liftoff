...
echo ""
echo "  1) ${GREEN}Coder${NC}      - Write code, debug, and ship features (recommended)"
...
echo ""
echo -e "  ${BLUE}Profile:${NC}        $([ "$PROFILE" = "1" ] && echo "Coder" || ([ "$PROFILE" = "2" ] && echo "Builder" || ([ "$PROFILE" = "3" ] && echo "Researcher" || echo "Full")))"
